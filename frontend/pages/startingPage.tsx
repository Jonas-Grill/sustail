    ...
    categories: [
        {
            ...
            sections: [
                ...
                },
                {
                    ...
                    name: 'Long lasting',
                    items: [
                        {name: 'Canned food', href: '#'},
                        {name: 'Noodles', href: '#'},
                        {name: 'grains', href: '#'},
                        {name: 'Bread and baked goods', href: '#'},
                    ],
                },
            ],
        },
    ...
    return (
        <div className="bg-white">
            ...
            <header className="relative bg-white">
                <p className="flex h-10 items-center justify-center bg-sustail px-4 text-sm font-medium text-white sm:px-6 lg:px-8">
                    Create an account and share your sustainability badges on instagram!
                </p>
