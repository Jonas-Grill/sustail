            ...
            <div className="bg-white">
                <div
                    ...
                    <div className="bg-white grid grid-cols-2 grid-rows-2 auto-cols-max gap-4">
                        ...
                        <div
                            className="row-span-2 d-flex flex-column align-items-center text-center shadow-lg shadow-2xl divide-y divide-sustail">
                            <div>
                            ...
                            <li className="flex items-center justify-between py-4">
                                <div className="flex items-start">
                                    <div className="ml-4">
                                        <p className="mt-1 flex text-sm text-gray-500">Overall Score</p>
                                        <p className="mt-1 flex text-sm text-gray-500">Shipping price</p>
                                        <p className="mt-2 text-2xl flex font-medium tracking-tight">Total price</p>
                                    </div>
                                </div>
                        ...
                        <div className="shadow-lg shadow-2xl bg-white">
                            ...
                            <div className="mt-3 ml-4 mr-2 grid grid-cols-1 gap-3 pr-48">
                                <button type="button"
                                ...
                                <button type="button"
                                    ...
                                    <svg className="ml-2 mr-1 w-5 h-5" aria-hidden="true" focusable="false"
                                ...
                                <button type="button"
                                    ...
                                    <svg className="mr-2 ml-1 w-10 h-3" viewBox="0 0 256 64" fill="none"
                                ...
                                <button type="button"
                                    ...
                                    <svg className="mr-2 ml-1 w-10 h-3" viewBox="0 0 660 203" fill="none"
                                         xmlns="http://www.w3.org/2000/svg">
                                        <path
                                ...
                                <button type="button"
                                    ...
                                    <svg className="mr-2 -ml-1 w-7 h-4" viewBox="0 0 601 360" fill="none"
                                         xmlns="http://www.w3.org/2000/svg">
                                        <path
