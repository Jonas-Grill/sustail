...
import productDetailEditable from "../pages/productDetailEditable";
                              ...
                              <div className="ml-4">
                                ...
                                <dl className="mt-1 space-y-1 text-xs text-gray-500">
                                  <div>
                                    ...
                                    <dd className="inline">Transport Method:</dd>
                                    <dd className="inline">
                                    </dd>
                    ...
                    <li className="flex items-center justify-between py-4">
                      <div className="flex items-start">
                        <div className="ml-4">
                          ...
                          <p className="mt-1 text-sm text-gray-500">Shipping price</p>
                          <p className="text-2xl font-medium tracking-tight">Total price</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center justify-between py-4">
                        <div>
                          ...
                          <p className="text-2xl font-medium tracking-tight"> 37.99$</p>
                        </div>
                      </div>
                    </li>
                  </div>
              ...
              <div className="bg-white py-12 md:py-24">
                <div className="mx-auto max-w-lg px-4 lg:px-8">
                  ...
                  <fieldset className="col-span-6">
                    ...
                    <button type="button" className="text-gray-900 bg-[#F7BE38] hover:bg-[#F7BE38]/90 focus:ring-4 focus:ring-[#F7BE38]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#F7BE38]/50 mr-2 mb-2">
                    ...
                    <button type="button" className="text-white bg-[#050708] hover:bg-[#050708]/80 focus:ring-4 focus:ring-[#050708]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:hover:bg-[#050708]/40 dark:focus:ring-gray-600 mr-2 mb-2">
                    ...
                    <button type="button" className="text-white bg-[#2557D6] hover:bg-[#2557D6]/90 focus:ring-4 focus:ring-[#2557D6]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#2557D6]/50 mr-2 mb-2">
                    ...
                    <button type="button" className="text-gray-900 bg-white hover:bg-gray-100 border border-gray-200 focus:ring-4 focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-800 dark:bg-white dark:border-gray-700 dark:text-gray-900 dark:hover:bg-gray-200 mr-2 mb-2">
                  ...
                  <form className="grid grid-cols-6 gap-4">
                    ...
                    <fieldset className="col-span-6">
                      ...
                      <div>
                        <label className="sr-only" htmlFor="Apartment, suite etc. (optional)">

                        </label>

                        <input
                          className="relative w-full border-gray-200 p-2.5 text-sm placeholder-gray-400 focus:z-10"
                          type="Apartment, suite etc. (optional)"
                          name="Apartment, suite etc. (optional)"
                          id="Apartment, suite etc. (optional)"
                      ...
                      <div className="-space-y-px rounded-lg bg-white shadow-sm">
                        <div>
                          ...
                          <select
                            className="relative w-full rounded-b-lg border-gray-200 p-2.5 text-sm focus:z-10"
                            id="country"
                            name="country"
